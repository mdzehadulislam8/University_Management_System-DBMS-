...
public class StudentLeave extends JFrame implements ActionListener {
    ...
    StudentLeave() {
        ...
        JLabel heading = new JLabel("Semester Drop (Student)");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String rollno = crollno.getSelectedItem();
            String query = "delete from studentleave where rollno = '" + rollno + "'";
            try {
                Conn c = new Conn();
                c.s.executeUpdate(query);
                JOptionPane.showMessageDialog(null, "Leave Record Deleted");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
